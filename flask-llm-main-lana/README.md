# Итоговая работа на курсе "Промпт-инжиниринг" 
# 🎬 Кино-консультант Фил

Веб-приложение "Кино-консультант Фил" - это интерактивный чат-помощник для подбора фильмов, созданный на базе Yandex GPT Lite. Приложение помогает пользователям выбрать кино под настроение, по жанру, актерам или другим критериям.

## ✨ Функциональность

- **🤖 Умный подбор фильмов** с помощью Yandex GPT Lite
- **🎬 Консультации** по фильмам, сериалам и мультфильмам
- **🔍 Поиск** по жанру, актерам, режиссерам
- **📱 Адаптивный дизайн** для всех устройств
- **💬 Интуитивный интерфейс** чата

## 🎯 Возможности помощника

- Помощь в выборе фильма, мультфильма или сериала
- Краткое описание кинокартин
...
- **🎨 Оранжево-фиолетовая цветовая гамма**
